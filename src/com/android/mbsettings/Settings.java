...
public class Settings extends PreferenceActivity
    ...
    private static final String SAVE_KEY_CURRENT_HEADER = "com.android.mbsettings.CURRENT_HEADER";
    private static final String SAVE_KEY_PARENT_HEADER = "com.android.mbsettings.PARENT_HEADER";
    ...
    public void setListAdapter(ListAdapter adapter) {
        if (adapter == null) {
            ...
            super.setListAdapter(new HeaderAdapter(this, getHeaders(), dpm));
        }
    }
